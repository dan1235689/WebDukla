...
(function($) {
    ...
    var $window = $(window);
        ...
        $window.on('scroll', function() {
            ...
            var logoD = $(".navbar-dukla_1 img");
            if (scroll <= 50) {
                $("header").removeClass("scrollHeader").addClass("fixedHeader");
                logoinner.attr('src', 'img/logos/dukla_logo_1.png');
                logodefault.attr('src', 'img/logos/dukla_logo_1.png');
                ...
                logoD.attr('src', 'img/logos/dukla_logo_1.png');
            } 
            else {
                ...
                logo7.attr('src', 'img/logos/logo-7.png');
                logo8.attr('src', 'img/logos/logo-8.png');
                logoD.attr('src', 'img/logs/dukla_logo_1');
            } 
        });
